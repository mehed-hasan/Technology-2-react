          ...
          <div className="row">
            <div className="col-md-5">
              ...
              <div className="about_us_images">
                <div className="row">
                  <div  className="col-5  ">
                    <div data-aos="left_flip" data-aos-duration="1500" style={{overflow:'overflow: hidden', backgroundImage:`url(${require(`../../images/about_us/${aboutData.contents.images.image1}`)})`}} className="about_image_1">
                    </div>
                  </div>
                  <div data-aos="left_flip" data-aos-duration="1500"  className="col-7  ">
                    <div className="about_image_2" style={{backgroundImage:`url(${require(`../../images/about_us/${aboutData.contents.images.image2}`)})`}}>
                    </div>
                  </div>

                  <div  className="col-12">
                    <div data-aos="wake-up" data-aos-duration="1800" className="about_image_3" style={{backgroundImage:`url(${require(`../../images/about_us/${aboutData.contents.images.image3}`)})`}}>
                    </div>
                  </div>
            ...
            <div className="col-md-7 ">
              <div className="abour_us_texts" data-aos="right-skew" data-aos-duration="1500">
                ...
                <div className="about_btn  text-center text-md-start">
                  <Link to="" className="blue_btn">Get Started</Link>
                </div>
              </div>
            </div>
          </div>
