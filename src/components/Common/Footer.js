...
function Footer() {
    return ( 
            ...
            <div className="row">
              <div className=" col-md-4 col-lg-4">
                <div className="logo_social">
                  <img src="assets/images/logo/light_logo.svg" alt=""/>
              ...
              <div className="col-md-4  col-lg-3 offset-lg-1 d-none d-md-block">
                ...
                <div className="useful_links">
                  <ul>
                    <li><Link to="">IT Design</Link></li>
                    <li><Link to="">IT Management</Link></li>
                    <li><Link to="">Data Security</Link></li>
                    <li><Link to="">Infrastructure Plan</Link></li>
                    <li><Link to="">Firewall Advancement</Link></li>
                    <li><Link to="">Desktop Computing</Link></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="col-md-4 col-lg-3 offset-lg-1 d-none d-md-block">
                ...
                <div className="useful_links">
                  <ul>
                    <li><a to="pages/about_us.html">About Us</a></li>
                    <li><a to="">Privacy Notice</a></li>
                  </ul>
                </div>
                ...
                <div className="useful_links">
                  ...
                  <ul>
                    <li><a to="tel:+009966789000">+009966789000</a></li>
                    <li><a to="mailto:companyemail@yahoo.com" style={{textTransform:'lowercase'}} >companyemail@yahoo.com</a></li>
                  </ul>
                </div>
              </div>
      ...
      <div className="useful_links text-center contact">
        ...
        <ul>
          <li><Link to="tel:+009966789000">+009966789000</Link></li>
          <li><Link to="mailto:companyemail@yahoo.com" style={{textTransform:'lowercase'}} >companyemail@yahoo.com</Link></li>
        </ul>
      </div>
